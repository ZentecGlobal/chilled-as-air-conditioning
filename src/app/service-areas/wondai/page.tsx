...
const faqItems = [
  {
    question: "Do you service Wondai regularly?",
    answer:
      "Yes, it's a quick trip from Nanango, so booking me in for a job in Wondai is no trouble at all. Give me a call to lock in a time that suits.",
  },
  {
    question: "What air con services are available in Wondai?",
    answer:
  ...
  {
    question: "Do you offer free quotes in Wondai?",
    answer:
      "Yes, every job in Wondai starts with a free, no-pressure quote.",
  },
];

export const metadata: Metadata = {
  title: "Air Conditioning in Wondai | Chilled As Air Conditioning",
  description:
    "Local air conditioning installation, servicing and repairs in Wondai, QLD. Call Jon for a free quote.",
};
        ...
        <Container>
          <FadeIn className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg leading-relaxed text-slate-300">
              ...
              a call to lock in a time that suits.
            </p>
        ...
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-12">
          <div>
            ...
            <p className="mt-4 max-w-xl text-lg leading-relaxed text-slate-700">
              Wondai is one of the towns I cover across the South Burnett
              region. Whether it&apos;s a home, a farm shed office, or a
              local business, I&apos;ll come take a look and give you a
              straight, free quote.
            </p>
          </div>
        ...
        <Container>
          <FadeIn className="relative mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-base leading-relaxed text-slate-300">
              Give me a call to sort a time, or send through your details
              and I&apos;ll get back to you with a free quote.
            </p>
            <a
              href={business.phoneHref}
